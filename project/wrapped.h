...
int FullRead(int sockfd, char *buffer, size_t count){
    int nread=0;
    size_t nleft = count;
    int totread=0;
    ...
    while (nleft > 0){
        ...
        nleft = nleft - nread; //Byte rimanenti da leggere
        buffer += nread; //Incrementa il puntatore per leggere i nuovi dati
